<x-guest-layout>
    <form class="form_container" method="POST" action="{{ route('login') }}">
        ...
        <div class="logo_container">
            <img src="{{ asset('images/gp-Logo.png') }}" alt="Logso de grupo piñero" width="80" height="80">
        </div>
        ...
        <div class="input_container">
            ...
            <input placeholder="name@mail.com" title="Inpit title" name="email" type="email" class="input_field"
