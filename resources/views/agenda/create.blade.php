                ...
                <form method="POST" action="#">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group input-group-merge">
                            ...
                            <x-text-input type="text" class="form-control" id="no_empleado" name="no_empleado"
                                placeholder="0038628" aria-label="0038628"
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group input-group-merge">
                            ...
                            <x-text-input type="text" class="form-control" id="puesto" name="puesto"
                                placeholder="Chef de partida" aria-label="Chef de partida"
                                aria-describedby="basic-icon-default-fullname2" required autofocus
                                autocomplete="puesto" />
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group input-group-merge">
                            ...
                            <x-text-input name="ad" class="form-control" id="ad" type="text"
                                placeholder="jkatrina" aria-label="jkatrina"
